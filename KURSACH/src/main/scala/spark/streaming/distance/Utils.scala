...
object Utils {
  ...
  def getDistance(plainPosition1: PlainPosition, plainPosition2: PlainPosition): Double = {
    getDistance(plainPosition1.plainLat: Double, plainPosition1.plainLat: Double, plainPosition2.plainLon: Double, plainPosition2.plainLon: Double)
  }
